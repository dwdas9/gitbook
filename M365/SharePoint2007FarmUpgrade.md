...
* [System Architecture & Design Recommendations](SharePoint2007FarmUpgrade.md#system-architecture--design-recommendations)
  ...
  * [Secure Topology Design Checklists](SharePoint2007FarmUpgrade.md#secure-topology-design-checklists)
...
* Microsoft Internet Explorer 6._x_ (32-bit)
...
| _Components_         | _Position_                                              | _Quantity_   | _Role_                        |
| -------------------- | ------------------------------------------------------- | ------------ | ----------------------------- |
...
| Ports                    | <p>- WFE servers</p><p>- Application servers</p>                       | <p>- Limit Internet-facing ports to port 80 for HTTP and port 443 for HTTPS.</p><p>- Use IPSec to encrypt or restrict intranet communication.</p><p> (<em>Refer the complete list below</em>)</p> |
| Sites and Virtual drives | <p>- WFE servers</p><p>- Application servers hosting Central Admin</p> | <p>- Move website to non-system drive.</p><p>- Restrict Web permissions in the IIS meta-base.</p><p>- Remove FrontPage Server extensions.</p>                                                     |
...
| IIS Lockdown             | <p>- WFE servers</p><p>- Application servers hosting Central Admin</p> | - Install URLScan to block requests that contain unsafe characters. It is installed automatically when _IISLockdown_ is run.                                                                      |
